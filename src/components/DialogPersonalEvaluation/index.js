...
const DialogPersonalEvaluation = ({ open, handleClose, evaluation }) => {
...
DialogPersonalEvaluation.propTypes = {
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
};

export default DialogPersonalEvaluation;
